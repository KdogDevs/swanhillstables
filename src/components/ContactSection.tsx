    ...
    <section id="contact" className="py-24 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <Card className="flex-1 max-w-sm mx-auto sm:mx-0">
            ...
            <div className="flex gap-4 justify-center">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`p-4 rounded-xl border bg-card text-muted-foreground transition-all duration-300 ${social.color} ${social.bgColor} hover:scale-105 hover:shadow-lg`}
